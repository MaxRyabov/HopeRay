...
Privacy manifest основного приложения и расширения MUST декларировать отсутствие сбора данных и трекинга. Это возможно, потому что Sentry удалён из приложения (`disable-telemetry-by-default`).
...
#### Scenario: Privacy manifest расширения
