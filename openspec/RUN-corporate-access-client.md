...
Этап 2, `stage/2-key-only-onboarding`. Ветка от `feat/corporate-access-client`, задачи 1.1–4.2, 5.1–5.3, 6.2 из `tasks.md` закрыты. Осталось: 5.4 (ручная проверка на пользователе) и 6.1 (зелёный CI). MR #6 в `feat/corporate-access-client`, коммит e5b1dd75.
