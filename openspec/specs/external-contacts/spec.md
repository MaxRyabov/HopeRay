# external-contacts Specification

## Purpose
TBD - created by archiving change remove-external-contacts. Update Purpose after archive.
## Requirements
...
Карточка профиля (`ProfileTile` на главном экране и в списке профилей) MUST NOT показывать ссылки сайта и поддержки провайдера, даже если они сохранены в базе у профилей, импортированных до обновления. В коде MUST NOT оставаться виджетов, которые рисуют эти ссылки.
